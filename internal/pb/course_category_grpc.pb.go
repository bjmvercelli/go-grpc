...
type CategoryServiceClient interface {
	...
	CreateCategoryBiDiStream(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBiDiStreamClient, error)
...
func (c *categoryServiceClient) CreateCategoryBiDiStream(ctx context.Context, opts ...grpc.CallOption) (CategoryService_CreateCategoryBiDiStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &CategoryService_ServiceDesc.Streams[1], "/pb.CategoryService/CreateCategoryBiDiStream", opts...)
	if err != nil {
		return nil, err
	}
	x := &categoryServiceCreateCategoryBiDiStreamClient{stream}
	return x, nil
}

type CategoryService_CreateCategoryBiDiStreamClient interface {
	Send(*CreateCategoryRequest) error
	Recv() (*Category, error)
	grpc.ClientStream
}

type categoryServiceCreateCategoryBiDiStreamClient struct {
	grpc.ClientStream
}

func (x *categoryServiceCreateCategoryBiDiStreamClient) Send(m *CreateCategoryRequest) error {
	return x.ClientStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBiDiStreamClient) Recv() (*Category, error) {
	m := new(Category)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type CategoryServiceServer interface {
	...
	CreateCategoryBiDiStream(CategoryService_CreateCategoryBiDiStreamServer) error
...
func (UnimplementedCategoryServiceServer) CreateCategoryBiDiStream(CategoryService_CreateCategoryBiDiStreamServer) error {
	return status.Errorf(codes.Unimplemented, "method CreateCategoryBiDiStream not implemented")
}
...
func _CategoryService_CreateCategoryBiDiStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(CategoryServiceServer).CreateCategoryBiDiStream(&categoryServiceCreateCategoryBiDiStreamServer{stream})
}

type CategoryService_CreateCategoryBiDiStreamServer interface {
	Send(*Category) error
	Recv() (*CreateCategoryRequest, error)
	grpc.ServerStream
}

type categoryServiceCreateCategoryBiDiStreamServer struct {
	grpc.ServerStream
}

func (x *categoryServiceCreateCategoryBiDiStreamServer) Send(m *Category) error {
	return x.ServerStream.SendMsg(m)
}

func (x *categoryServiceCreateCategoryBiDiStreamServer) Recv() (*CreateCategoryRequest, error) {
	m := new(CreateCategoryRequest)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "CreateCategoryBiDiStream",
			Handler:       _CategoryService_CreateCategoryBiDiStream_Handler,
			ServerStreams: true,
			ClientStreams: true,
		},
	},
